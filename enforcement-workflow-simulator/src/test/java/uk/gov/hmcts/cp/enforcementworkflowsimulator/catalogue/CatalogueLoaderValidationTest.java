 ...
 * {@code enforcement-workflow-simulator/catalogue-fixtures/<scenario>/} is a full copy of the production catalogue
...
class CatalogueLoaderValidationTest {
    ...
    private static final String FIXTURES_BASE = "enforcement-workflow-simulator/catalogue-fixtures/";
    ...
    void rejects_a_result_code_row_referencing_an_unknown_field_label() {
        assertThatThrownBy(() -> new CatalogueLoader(FIXTURES_BASE + "unknown-field-label/").load())
                ...
                .hasMessage("""
                        Invalid enforcement workflow simulator catalogue:
